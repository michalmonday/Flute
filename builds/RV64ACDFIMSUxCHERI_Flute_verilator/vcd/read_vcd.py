...
# String below was copied from Flute source file: GenerateHPMVector.bsv
# The GenerateHPMVector.bsv file is generated by the python script from Flute/builds/Resources/
events_definitions = '''
