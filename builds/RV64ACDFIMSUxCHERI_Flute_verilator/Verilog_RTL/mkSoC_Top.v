...
module mkSoC_Top(CLK,
  ...
  wire [63 : 0] addr__h40872,
		...
		y__h6154,
		y__h6912;
  wire [8 : 0] x__h12971, x__h6507;
  wire [7 : 0] x1__h12875, x1__h13591, x1__h6411, x1__h7130;
  wire [6 : 0] _theResult____h67280, currentAwid__h67465;
  ...
  // register bus_noRouteSlv_awidReg
  assign bus_noRouteSlv_awidReg$D_IN = _theResult____h67280 ;
  ...
  assign boot_rom$set_addr_map_addr_lim = addr_lim__h132888 ;
  ...
  // submodule bus_noRouteSlv_rspFF
  assign bus_noRouteSlv_rspFF$D_IN = { _theResult____h67280, 2'd3 } ;
  ...
  assign mem0_controller$set_addr_map_addr_lim = addr_lim__h132916 ;
  ...
  assign uart0$set_addr_map_addr_lim = addr_lim__h132942 ;
  ...
  assign IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1000 =
	     addr__h40872 < soc_map$m_boot_rom_addr_range[127:64] ;
  assign IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1003 =
	     x__h41276 < soc_map$m_boot_rom_addr_range[63:0] ;
  assign IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1008 =
	     addr__h40872 < soc_map$m_mem0_controller_addr_range[127:64] ;
  assign IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1011 =
	     x__h41349 < soc_map$m_mem0_controller_addr_range[63:0] ;
  ...
  assign IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1050 =
	     addr__h42360 < soc_map$m_boot_rom_addr_range[127:64] ;
  assign IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1052 =
	     x__h42707 < soc_map$m_boot_rom_addr_range[63:0] ;
  assign IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1055 =
	     addr__h42360 < soc_map$m_mem0_controller_addr_range[127:64] ;
  assign IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1057 =
	     x__h42770 < soc_map$m_mem0_controller_addr_range[63:0] ;
  ...
  assign _0_OR_NOT_IF_bus_merged_0_outflit_whas__72_AND__ETC___d1015 =
	     addr__h40872 >= soc_map$m_uart0_addr_range[127:64] &&
	     x__h41430 < soc_map$m_uart0_addr_range[63:0] &&
	     (IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1000 ||
	      !IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1003) &&
	     (IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1008 ||
	      !IF_bus_merged_0_outflit_whas__72_AND_NOT_bus_m_ETC___d1011) ;
  assign _0_OR_NOT_IF_bus_merged_1_outflit_whas__027_AND_ETC___d1061 =
	     addr__h42360 >= soc_map$m_uart0_addr_range[127:64] &&
	     x__h42841 < soc_map$m_uart0_addr_range[63:0] &&
	     (IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1050 ||
	      !IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1052) &&
	     (IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1055 ||
	      !IF_bus_merged_1_outflit_whas__027_AND_NOT_bus__ETC___d1057) ;
  assign _0_OR_NOT_core_core_mem_master_ar_peek__715_BIT_ETC___d1735 =
	     ...
	     x__h92170 < soc_map$m_uart0_addr_range[63:0] &&
	     (core_core_mem_master_ar_peek__715_BITS_92_TO_2_ETC___d1724 ||
	      !core_core_mem_master_ar_peek__715_BITS_92_TO_2_ETC___d1726) &&
	     (core_core_mem_master_ar_peek__715_BITS_92_TO_2_ETC___d1729 ||
	      !core_core_mem_master_ar_peek__715_BITS_92_TO_2_ETC___d1731) ;
  assign _0_OR_NOT_core_cpu_imem_master_ar_peek__685_BIT_ETC___d1705 =
	     ...
	     soc_map$m_uart0_addr_range[127:64] &&
	     x__h90832 < soc_map$m_uart0_addr_range[63:0] &&
	     (core_cpu_imem_master_ar_peek__685_BITS_92_TO_2_ETC___d1694 ||
	      !core_cpu_imem_master_ar_peek__685_BITS_92_TO_2_ETC___d1696) &&
	     (core_cpu_imem_master_ar_peek__685_BITS_92_TO_2_ETC___d1699 ||
	      !core_cpu_imem_master_ar_peek__685_BITS_92_TO_2_ETC___d1701) ;
  assign _theResult____h67280 =
  ...
  assign core_core_mem_master_ar_peek__715_BITS_92_TO_2_ETC___d1726 =
	     x__h92036 < soc_map$m_boot_rom_addr_range[63:0] ;
  ...
  assign core_core_mem_master_ar_peek__715_BITS_92_TO_2_ETC___d1731 =
	     x__h92099 < soc_map$m_mem0_controller_addr_range[63:0] ;
  ...
  assign core_cpu_imem_master_ar_peek__685_BITS_92_TO_2_ETC___d1696 =
	     x__h90698 < soc_map$m_boot_rom_addr_range[63:0] ;
  ...
  assign core_cpu_imem_master_ar_peek__685_BITS_92_TO_2_ETC___d1701 =
	     x__h90761 < soc_map$m_mem0_controller_addr_range[63:0] ;
  assign currentAwid__h67465 =
  ...
  assign x1__h12875 = mem0_controller_axi4_deburster_writesSent + 8'd1 ;
  assign x1__h13591 = mem0_controller_axi4_deburster_readsSent + 8'd1 ;
  assign x1__h6411 = boot_rom_axi4_deburster_writesSent + 8'd1 ;
  assign x1__h7130 = boot_rom_axi4_deburster_readsSent + 8'd1 ;
  assign x__h12632 = { 56'd0, mem0_controller_axi4_deburster_writesSent } ;
  assign x__h12971 =
	     mem0_controller_axi4_deburster_flitReceived[17:9] + 9'd1 ;
  assign x__h13385 = { 56'd0, mem0_controller_axi4_deburster_readsSent } ;
  assign x__h41276 = addr__h40872 - soc_map$m_boot_rom_addr_range[127:64] ;
  assign x__h41349 =
	     addr__h40872 - soc_map$m_mem0_controller_addr_range[127:64] ;
  assign x__h41430 = addr__h40872 - soc_map$m_uart0_addr_range[127:64] ;
  assign x__h42707 = addr__h42360 - soc_map$m_boot_rom_addr_range[127:64] ;
  assign x__h42770 =
	     addr__h42360 - soc_map$m_mem0_controller_addr_range[127:64] ;
  assign x__h42841 = addr__h42360 - soc_map$m_uart0_addr_range[127:64] ;
  assign x__h6166 = { 56'd0, boot_rom_axi4_deburster_writesSent } ;
  assign x__h6507 = boot_rom_axi4_deburster_flitReceived[17:9] + 9'd1 ;
  assign x__h6924 = { 56'd0, boot_rom_axi4_deburster_readsSent } ;
  assign x__h90698 =
	     core$cpu_imem_master_ar_peek[92:29] -
	     soc_map$m_boot_rom_addr_range[127:64] ;
  assign x__h90761 =
  ...
  begin
    ...
    v__h133114 = v__h133120 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete_initial)
	$display("%0d:%m.rl_reset_complete_initial", v__h133114);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h132760 = v__h132766 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_initial)
	$display("%0d:%m.rl_reset_start_initial ...", v__h132760);
    if (RST_N != `BSV_RESET_VALUE)
