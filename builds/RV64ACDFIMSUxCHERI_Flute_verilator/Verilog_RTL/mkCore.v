...
module mkCore(CLK,
  ...
  wire [63 : 0] addr__h35401,
		...
		x__h9309;
  wire [39 : 0] x__h12033;
  wire [7 : 0] arlen__h19194, aw_awlen__h12002, v_arlen__h19211;
  wire [5 : 0] v_arid__h19209;
  wire [4 : 0] _theResult____h60654, currentAwid__h60839;
  wire [3 : 0] _0_CONCAT_axi4_mem_shim_tmp_tagCon_memory_reque_ETC___d302,
	       ...
	       y__h14709,
	       y__h14721;
  wire [2 : 0] arsize_val__h19344,
	       aw_awsize_val__h14578,
	       v_arsize_val__h19345;
  ...
  assign CAN_FIRE_RL_output_selected_5 = x__h123563 ;
  assign WILL_FIRE_RL_output_selected_5 = x__h123563 ;
  ...
  assign CAN_FIRE_RL_split_0_awug_doPut = x__h123511 ;
  assign WILL_FIRE_RL_split_0_awug_doPut = x__h123511 ;
  ...
  assign inputDest_0$wget =
	     { IF_merged_0_outflit_whas__90_AND_NOT_merged_0__ETC___d720,
	       addr__h35401[63:40] == 24'd0 &&
	       !IF_merged_0_outflit_whas__90_AND_NOT_merged_0__ETC___d709 &&
	       IF_merged_0_outflit_whas__90_AND_NOT_merged_0__ETC___d711,
	       IF_merged_0_outflit_whas__90_AND_NOT_merged_0__ETC___d727 } ;
  assign inputDest_1$wget =
	     { IF_merged_1_outflit_whas__33_AND_NOT_merged_1__ETC___d763,
	       addr__h36274[63:40] == 24'd0 &&
	       !IF_merged_1_outflit_whas__33_AND_NOT_merged_1__ETC___d752 &&
	       IF_merged_1_outflit_whas__33_AND_NOT_merged_1__ETC___d754,
	       IF_merged_1_outflit_whas__33_AND_NOT_merged_1__ETC___d770 } ;
  ...
  // register noRouteSlv_awidReg
  assign noRouteSlv_awidReg$D_IN = _theResult____h60654 ;
  ...
  // submodule noRouteSlv_rspFF
  assign noRouteSlv_rspFF$D_IN = { _theResult____h60654, 2'd3 } ;
  ...
  assign cpu_mem_master_ar_peek__377_BITS_92_TO_29_381__ETC___d1384 =
	     x__h83720 < soc_map$m_near_mem_io_addr_range[63:0] ;
  ...
  assign cpu_mem_master_ar_peek__377_BITS_92_TO_29_381__ETC___d1390 =
	     x__h83745 < soc_map$m_plic_addr_range[63:0] ;
  ...
  assign moreFlits_1_1_486_BIT_5_487_AND_moreFlits_1_1__ETC___d1575 =
	     ...
	     ((moreFlits_1_1[0] ? 2'd1 : 2'd0) +
	      ...
	      noRouteSlv_1_flitCount == 9'd0 ||
	      IF_NOT_moreFlits_1_1_486_BIT_0_556_567_OR_NOT__ETC___d1573) ;
  assign tmp__h11843 = { 24'd0, x__h12033 } ;
  assign tmp__h9448 =
	     axi4_mem_shim_tmp_awreqff$D_OUT[92:29] +
	     axi4_mem_shim_tmp_addrOffset ;
  assign v_araddr__h19210 =
	     (axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       araddr__h19193 :
	       64'hAAAAAAAAAAAAAAAA ;
  assign v_arid__h19209 =
	     (axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       axi4_mem_shim_tmp_tagCon$memory_request_get[100:95] :
	       6'd0 ;
  assign v_arlen__h19211 =
	     (axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       arlen__h19194 :
	       8'd0 ;
  assign v_arsize_val__h19345 =
	     (axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       arsize_val__h19344 :
	       3'b0 ;
  assign w_wdata__h17134 =
	     (axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd1) ?
	       axi4_mem_shim_tmp_tagCon$memory_request_get[71:8] :
	       64'hAAAAAAAAAAAAAAAA ;
  assign x__h12033 =
			...
			(axi4_mem_shim_tmp_tagCon$memory_request_get[85] ?
			   ...
			   (axi4_mem_shim_tmp_tagCon$memory_request_get[86] ?
				 ...
				 (axi4_mem_shim_tmp_tagCon$memory_request_get[88] ?
				    4'd7 :
				    4'd8))))))) ;
  assign x__h123459 = { 63'd0, x__h123511 } ;
  assign x__h123511 =
	     !axi4_mem_shim_tmp_shimSlave_awff_rv[98] &&
	     MUX_split_0_flitLeft$write_1__SEL_2 ;
  assign x__h123523 = { 63'd0, x__h123526 } ;
  assign x__h123526 =
	     CAN_FIRE_RL_split_0_wug_doPut &&
	     axi4_mem_shim_slave_monitor_wMonitor_evt$wget[1] ;
  assign x__h123547 = { 63'd0, x__h123550 } ;
  assign x__h123550 =
	     CAN_FIRE_RL_split_0_wug_doPut &&
	     axi4_mem_shim_slave_monitor_wMonitor_evt$wget[0] ;
  assign x__h123553 = { 63'd0, x__h123556 } ;
  assign x__h123556 =
	     WILL_FIRE_RL_input_follow_flit_3 ||
	     WILL_FIRE_RL_input_first_flit_3 ;
  assign x__h123560 = { 63'd0, x__h123563 } ;
  assign x__h123563 =
	     toOutput_1_0$whas && !axi4_mem_shim_tmp_shimSlave_arff_rv[98] ;
  assign x__h123567 = { 63'd0, x__h123570 } ;
  assign x__h123570 =
	     axi4_mem_shim_slave_monitor_rMonitor_evt$whas &&
	     axi4_mem_shim_slave_monitor_rMonitor_evt$wget[1] ;
  assign x__h123586 = { 63'd0, x__h123589 } ;
  assign x__h123589 =
	     axi4_mem_shim_slave_monitor_rMonitor_evt$whas &&
	     axi4_mem_shim_slave_monitor_rMonitor_evt$wget[0] ;
  assign x__h123603 = { 63'd0, EN_core_mem_master_aw_drop } ;
  assign x__h123667 = { 63'd0, x__h123670 } ;
  assign x__h123670 =
	     EN_core_mem_master_w_drop &&
  ...
  assign x__h123698 = { 63'd0, EN_core_mem_master_b_put } ;
  assign x__h123705 = { 63'd0, EN_core_mem_master_ar_drop } ;
  assign x__h123712 = { 63'd0, x__h123715 } ;
  assign x__h123715 =
	     EN_core_mem_master_r_put &&
	     axi4_mem_shim_master_monitor_rMonitor_evt$wget[1] ;
  assign x__h123731 = { 63'd0, x__h123734 } ;
  assign x__h123734 =
	     EN_core_mem_master_r_put &&
	     axi4_mem_shim_master_monitor_rMonitor_evt$wget[0] ;
  assign x__h123748 = { 63'd0, axi4_mem_shim_tmp_tagCon$events[6] } ;
  assign x__h123779 = { 63'd0, axi4_mem_shim_tmp_tagCon$events[5] } ;
  assign x__h123786 = { 63'd0, axi4_mem_shim_tmp_tagCon$events[4] } ;
  assign x__h123793 = { 63'd0, axi4_mem_shim_tmp_tagCon$events[3] } ;
  assign x__h123800 = { 63'd0, axi4_mem_shim_tmp_tagCon$events[2] } ;
  assign x__h14648 = x__h14660 + y__h14661 ;
  assign x__h14660 = x__h14672 + y__h14673 ;
  assign x__h14672 = x__h14684 + y__h14685 ;
  assign x__h14684 = x__h14696 + y__h14697 ;
  assign x__h14696 = x__h14708 + y__h14709 ;
  assign x__h14708 = x__h14720 + y__h14721 ;
  assign x__h14720 =
  ...
  assign x__h19447 =
	     (axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd0) ?
	       arcache__h19198 :
	       4'd0 ;
  assign x__h35460 = addr__h35401 - soc_map$m_near_mem_io_addr_range[127:64] ;
  assign x__h35485 = addr__h35401 - soc_map$m_plic_addr_range[127:64] ;
  assign x__h36331 = addr__h36274 - soc_map$m_near_mem_io_addr_range[127:64] ;
  assign x__h36356 = addr__h36274 - soc_map$m_plic_addr_range[127:64] ;
  assign x__h83720 =
	     cpu$mem_master_ar_peek[92:29] -
	     soc_map$m_near_mem_io_addr_range[127:64] ;
  assign x__h83745 =
  ...
  begin
	...
	if (WILL_FIRE_RL_axi4_mem_shim_tmp_passMemoryRequest &&
	    (TASK_testplusargs___d341 || TASK_testplusargs___d342) &&
	    axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] != 2'd1)
	  $write("'h%h", v_arsize_val__h19345, " }");
    if (RST_N != `BSV_RESET_VALUE)
      if (axi4_mem_shim_tmp_newRst$OUT_RST != `BSV_RESET_VALUE)
	if (WILL_FIRE_RL_axi4_mem_shim_tmp_passMemoryRequest &&
	    (TASK_testplusargs___d341 || TASK_testplusargs___d342) &&
	...
	if (WILL_FIRE_RL_axi4_mem_shim_tmp_passMemoryRequest &&
	    (TASK_testplusargs___d341 || TASK_testplusargs___d342) &&
	    axi4_mem_shim_tmp_tagCon$memory_request_get[93:92] == 2'd1)
	  $write("'h%h", aw_awsize_val__h14578, " }");
    if (RST_N != `BSV_RESET_VALUE)
      if (axi4_mem_shim_tmp_newRst$OUT_RST != `BSV_RESET_VALUE)
	if (WILL_FIRE_RL_axi4_mem_shim_tmp_passMemoryRequest &&
	    (TASK_testplusargs___d341 || TASK_testplusargs___d342) &&
    ...
    v__h22256 = v__h22262 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h22256);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h22470 = v__h22476 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h22470);
  end
  // synopsys translate_on
endmodule  // mkCore
