...
module mkFPU(CLK,
  ...
  assign MUX_rg_done$write_1__SEL_1 =
  ...
  assign crg_busy$port2__read =
	     MUX_rg_done$write_1__SEL_1 || crg_busy$port1__read ;
  ...
  // register rg_done
  assign rg_done$D_IN =
	     !MUX_rg_done$write_1__SEL_1 && MUX_rg_done$write_1__VAL_2 ;
  assign rg_done$EN =
	     WILL_FIRE_RL_fpu_div_s2_stage && !fpu_div_fState_S1$D_OUT[318] ||
	     WILL_FIRE_RL_work ;
  ...
  assign rg_index$D_IN =
	     MUX_rg_done$write_1__SEL_1 ? 7'd0 : MUX_rg_index$write_1__VAL_2 ;
  assign rg_index$EN =
	     WILL_FIRE_RL_fpu_div_s2_stage && !fpu_div_fState_S1$D_OUT[318] ||
	     WILL_FIRE_RL_work ;
