...
// instr                          O    32
// pc_valid                       O     1
// evt_MEM_CAP_LOAD               O    64
// evt_MEM_CAP_STORE              O    64
// evt_MEM_CAP_LOAD_TAG_SET       O    64
// evt_MEM_CAP_STORE_TAG_SET      O    64
// tgc_evt_WRITE                  O    64
// tgc_evt_WRITE_MISS             O    64
// tgc_evt_READ                   O    64
// tgc_evt_READ_MISS              O    64
// tgc_evt_EVICT                  O    64
// tgc_evt_SET_TAG_WRITE          O    64
// tgc_evt_SET_TAG_READ           O    64
// axi_mem_aw_canPut              O     1
// RDY_axi_mem_aw_put             O     1 const
// axi_mem_w_canPut               O     1
// RDY_axi_mem_w_put              O     1 const
// axi_mem_b_canPeek              O     1
// axi_mem_b_peek                 O     8
// RDY_axi_mem_b_peek             O     1 const
// RDY_axi_mem_b_drop             O     1 const
// axi_mem_ar_canPut              O     1
// RDY_axi_mem_ar_put             O     1 const
// axi_mem_r_canPeek              O     1
// axi_mem_r_peek                 O   521
...
module mkContinuousMonitoring(CLK,
  ...
  // value method pc_valid
  assign pc_valid = 1'bx /* unspecified value */  ;

  // value method evt_MEM_CAP_LOAD
  assign evt_MEM_CAP_LOAD =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method evt_MEM_CAP_STORE
  assign evt_MEM_CAP_STORE =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method evt_MEM_CAP_LOAD_TAG_SET
  assign evt_MEM_CAP_LOAD_TAG_SET =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method evt_MEM_CAP_STORE_TAG_SET
  assign evt_MEM_CAP_STORE_TAG_SET =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method tgc_evt_WRITE
  assign tgc_evt_WRITE =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method tgc_evt_WRITE_MISS
  assign tgc_evt_WRITE_MISS =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;
  ...
  // value method tgc_evt_READ_MISS
  assign tgc_evt_READ_MISS =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method tgc_evt_EVICT
  assign tgc_evt_EVICT =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method tgc_evt_SET_TAG_WRITE
  assign tgc_evt_SET_TAG_WRITE =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method tgc_evt_SET_TAG_READ
  assign tgc_evt_SET_TAG_READ =
	     64'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;

  // value method axi_mem_aw_canPut
  assign axi_mem_aw_canPut = 1'bx /* unspecified value */  ;
  ...
  // value method axi_mem_w_canPut
  assign axi_mem_w_canPut = 1'bx /* unspecified value */  ;
  ...
  // value method axi_mem_b_canPeek
  assign axi_mem_b_canPeek = 1'bx /* unspecified value */  ;

  // value method axi_mem_b_peek
  assign axi_mem_b_peek = 8'bxxxxxxxx /* unspecified value */  ;
  ...
  // value method axi_mem_ar_canPut
  assign axi_mem_ar_canPut = 1'bx /* unspecified value */  ;
  ...
  // value method axi_mem_r_canPeek
  assign axi_mem_r_canPeek = 1'bx /* unspecified value */  ;
