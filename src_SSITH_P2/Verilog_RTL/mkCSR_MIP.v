...
// m_external_interrupt_req_req   I     1
// s_external_interrupt_req_req   I     1
...
module mkCSR_MIP(CLK,
  ...
  // register rg_meip
  assign rg_meip$D_IN =
	     EN_m_external_interrupt_req && m_external_interrupt_req_req ;
  assign rg_meip$EN = EN_m_external_interrupt_req || EN_reset ;
  ...
  // register rg_seip
  always@(EN_s_external_interrupt_req or
	  s_external_interrupt_req_req or
	  EN_reset or EN_mav_write or seip__h632)
  case (1'b1)
    EN_s_external_interrupt_req: rg_seip$D_IN = s_external_interrupt_req_req;
    EN_reset: rg_seip$D_IN = 1'd0;
    EN_mav_write: rg_seip$D_IN = seip__h632;
    default: rg_seip$D_IN = 1'bx /* unspecified value */ ;
  endcase
  assign rg_seip$EN =
	     EN_s_external_interrupt_req || EN_mav_write || EN_reset ;
