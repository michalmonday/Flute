...
module mkNear_Mem(CLK,
  ...
  assign x__h1978 = { 63'd0, icache$events[13] } ;
  assign x__h2025 = { 63'd0, icache$events[12] } ;
  assign x__h2032 = { 63'd0, icache$events[11] } ;
  assign x__h2039 = { 63'd0, icache$events[4] } ;
  assign x__h2058 = { 63'd0, icache$events[3] } ;
  assign x__h2065 = { 63'd0, icache$events[2] } ;
  assign x__h2072 = { 63'd0, icache$events[1] } ;
  assign x__h2621 = { 63'd0, dcache$events[13] } ;
  assign x__h2672 = { 63'd0, dcache$events[12] } ;
  assign x__h2679 = { 63'd0, dcache$events[11] } ;
  assign x__h2686 = { 63'd0, dcache$events[10] } ;
  assign x__h2693 = { 63'd0, dcache$events[9] } ;
  assign x__h2700 = { 63'd0, dcache$events[8] } ;
  assign x__h2707 = { 63'd0, dcache$events[7] } ;
  assign x__h2714 = { 63'd0, dcache$events[6] } ;
  assign x__h2721 = { 63'd0, dcache$events[5] } ;
  assign x__h2728 = { 63'd0, dcache$events[4] } ;
  assign x__h2735 = { 63'd0, dcache$events[3] } ;
  assign x__h2742 = { 63'd0, dcache$events[2] } ;
  assign x__h2749 = { 63'd0, dcache$events[1] } ;
  assign x__h2756 = { 63'd0, dcache$events[0] } ;
